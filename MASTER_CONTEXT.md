# MASTER CONTEXT — Pub Games Studio

**Identificador Canônico:** `pub-games-studio`  
**Vertical:** Games  
**Holding:** PUB Core Holding  
**Status de Maturidade:** IDEA / PROTOTYPE  
...
Desenvolvimento de jogos independentes e gamificação corporativa.
...
- **Maturidade Atual:** `IDEA / PROTOTYPE`
...
- **Repositório GitHub:** `pubcoreagencia/pub-games-studio`
